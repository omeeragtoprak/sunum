...
```
KAYNAK: Tek bir master PDF — "EBB Akıllı Şehir Projeleri, Kurumsal Tanıtım Sunumu 2026", 68 sayfa. Kapak ve sunum planı sayfasından sonra BÖLÜM 1'den BÖLÜM 11'e kadar numaralandırılmış on bir proje bölümü vardır.
...
BÖLÜM 1 — ParkNet Akıllı Otopark Yönetim Sistemi (belgede 40 ekran görüntüsü) — EN AYRINTILI BÖLÜM
...
Kaynak belgede toplam 94 adet gerçek yazılım arayüzü ekran görüntüsü vardır. Videonun görsel akışı yalnızca bu gerçek ekran görüntüleri üzerine kurulur.
...
- **Kaynak:** master PDF `kaynaklar/master/EBB-Akilli-Sehir-Projeleri-Master-Sunum.pdf`
  (68 sayfa, 94 ekran görüntüsü). Notebook'ta tek kaynak olarak bulunmalı.
